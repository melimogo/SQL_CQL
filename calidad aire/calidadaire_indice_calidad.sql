...
--
-- Dumping data for table `indice_calidad`
--

LOCK TABLES `indice_calidad` WRITE;
/*!40000 ALTER TABLE `indice_calidad` DISABLE KEYS */;
INSERT INTO `indice_calidad` VALUES (1,'Muy Dañina a la salud','morado',1),(2,'Buena','Verde',2),(3,'Moderada','Amarillo',5),(4,'Buena','Verde',6);
/*!40000 ALTER TABLE `indice_calidad` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-04-28  1:20:50
